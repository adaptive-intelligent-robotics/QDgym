...
# Robot Deterministic OmnidirectionalAnt
class DeterministicOmnidirectionalAnt(DeterministicAnt):
    ...
    def robot_specific_reset(self, bullet_client):
        self.initial_x = None
        self.initial_y = None
        DeterministicAnt.robot_specific_reset(self, bullet_client)
...
# Bullet standard Deterministic OmnidirectionalAntBulletEnv environment
class DeterministicOmnidirectionalAntBulletEnv(WalkerBaseBulletEnv):
    PRIOR_STATE_INFORMATION = "prior_state_information"

    def __init__(self, render=False, do_consider_xy_pos=False):
        self.robot = DeterministicOmnidirectionalAnt(do_consider_xy_pos)
        self.do_consider_xy_pos = do_consider_xy_pos
        WalkerBaseBulletEnv.__init__(self, self.robot, render)

    def step(self, a):
        state, reward, done, info_dict = super(DeterministicOmnidirectionalAntBulletEnv, self).step(a)
...
# QD version of Deterministic OmnidirectionalAntBulletEnv
class QDDeterministicAntOmnidirectionalBulletEnv(DeterministicOmnidirectionalAntBulletEnv):
